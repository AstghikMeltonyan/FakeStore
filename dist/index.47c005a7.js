...
})({"9Zw3w":[function(require,module,exports) {
...
function catalogProducts(id) {
    ...
    return (0, _redom.el)("div", [
        (0, _redom.el)("h1", "product description"),
        body
    ]);
}
router.on("/", ()=>{
...
router.on("/product/:id", ({ data: { id } })=>{
    (0, _redom.setChildren)(window.document.body, catalogProducts(id));
});
router.resolve();
...
},{}]},["9Zw3w","8Duvb"], "8Duvb", "parcelRequirefeec")
